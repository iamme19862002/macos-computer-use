...
# 2. 创建项目目录
macos-computer-use type --app Terminal --text "mkdir -p ~/Projects/new-project && cd ~/Projects/new-project"
macos-computer-use key --app Terminal --key return

# 3. 初始化 Git
macos-computer-use type --app Terminal --text "git init"
macos-computer-use key --app Terminal --key return

# 4. 创建 README
macos-computer-use type --app Terminal --text "echo '# New Project' > README.md"
macos-computer-use key --app Terminal --key return
...
# 7. 创建初始文件
macos-computer-use hotkey --keys command+n
macos-computer-use type --app "Visual Studio Code" --text "console.log('Hello World');"
macos-computer-use hotkey --keys command+s
macos-computer-use type --text "index.js"
macos-computer-use key --key return
