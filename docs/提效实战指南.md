...
# 定义要导入的文件列表
FILES=(
  "/Users/wangmin/Documents/ProjectA/report.pdf"
  "/Users/wangmin/Documents/ProjectA/data.xlsx"
  "/Users/wangmin/Documents/ProjectA/presentation.pptx"
)

# 启动目标应用
macos-computer-use app-launch --app "Documents"
macos-computer-use wait-for-app --app "Documents" --timeout 10
...
# 启动设计应用
macos-computer-use app-launch --app "$DEST_APP"
macos-computer-use wait-for-app --app "$DEST_APP" --timeout 10
...
# 截图保存整理结果
macos-computer-use screenshot --app "$DEST_APP" --output ~/Documents/asset_organization_$(date +%Y%m%d_%H%M%S).png
...
# 格式: "源文件路径|目标应用|按钮标题"
ARCHIVE_RULES=(
  "/Users/wangmin/Documents/Invoices/invoice_2026_01.pdf|财务管理|导入发票"
  "/Users/wangmin/Documents/Contracts/contract_2026_01.pdf|合同管理|上传合同"
  "/Users/wangmin/Documents/Reports/monthly_report.pdf|报表系统|导入报表"
)
...
for rule in "${ARCHIVE_RULES[@]}"; do
  ...
  # 启动目标应用
  macos-computer-use app-launch --app "$app_name"
  macos-computer-use wait-for-app --app "$app_name" --timeout 10
