...
# 3. 截图当前状态
macos-computer-use screenshot --output /tmp/current_homepage.png
...
macos-computer-use screenshot --output /tmp/current_footer.png
...
macos-computer-use wait-for-app --app TextEdit --timeout 10
...
if __name__ == "__main__":
    ...
    success = select_file_in_dialog(
        app_name="LyricVoice",
        button_title="添加文件",
        file_path="/Users/wangmin/traeProjects/LyricVoice/test/audio/chinese_10s.wav"
    )
    print(f"文件选择结果: {'成功' if success else '失败'}")
    
    # 批量文件选择
    files = [
        "/Users/wangmin/traeProjects/LyricVoice/test/audio/chinese_10s.wav",
        "/Users/wangmin/traeProjects/LyricVoice/test/audio/chinese_1min.mp3",
        "/Users/wangmin/traeProjects/LyricVoice/test/audio/english_30s.wav"
    ]
...
macos-computer-use step --name "启动应用"
macos-computer-use app-launch --app "LyricVoice"
...
if echo "$RESULT" | grep -q '"success":true'; then
    ...
    echo "✗ 文件选择失败"
    macos-computer-use screenshot --output upload_error.png
...
if macos-computer-use assert-text-exists --app "LyricVoice" --text "chinese_10s.wav" --timeout 5; then
    ...
    echo "✗ 文件未显示在列表中"
    macos-computer-use screenshot --output verify_error.png
    macos-computer-use test-end --result fail --reason "文件未显示"
    exit 1
fi

# 6. 截图保存成功状态
macos-computer-use screenshot --output upload_success.png
...
# 3. 获取初始页面内容
macos-computer-use ocr --app Safari --format json > /tmp/page_content.json
...
for i in {1..10}; do
    ...
    macos-computer-use ocr --output /tmp/page_section_$i.png --format json >> /tmp/page_content.json
...
class MacOSComputerUse:
    ...
    def drag(self, from_x: Optional[int] = None, from_y: Optional[int] = None, to_x: Optional[int] = None, to_y: Optional[int] = None, from_app: Optional[str] = None, from_target: Optional[str] = None, to_app: Optional[str] = None, to_target: Optional[str] = None) -> Dict:
        ...
        if from_x is not None and from_y is not None:
            cmd += f" --from-x {from_x} --from-y {from_y}"
...
# 12. 对比截图定位 UI 变化
macos-computer-use screenshot --output after_change.png
