...
# 列出文件选择器中的按钮
macos-computer-use element-list --app TextEdit --type button
...
macos-computer-use dialog-open-file --app "LyricVoice" --button "添加文件" --path "/Users/wangmin/traeProjects/LyricVoice/test/audio/chinese_10s.wav"
