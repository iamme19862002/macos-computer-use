...
```bash
# 点击文件选择器中的「打开」按钮
macos-computer-use element-click --app TextEdit --sheet --name "打开"

# 点击文件选择器中的「取消」按钮
macos-computer-use element-click --app TextEdit --sheet --name "取消"

# 点击文件选择器中的「前往文件夹」按钮
macos-computer-use element-click --app TextEdit --sheet --name "前往文件夹"

# 结合 element-list 查找并点击
macos-computer-use element-list --app TextEdit --sheet --type button
macos-computer-use element-click --app TextEdit --sheet --name "打开" --role button
```
